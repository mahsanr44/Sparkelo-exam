                ...
                <div className='m-6'>
                    <form action="" className='space-y-1'>
                        ...
                        <input
                            ...
                            value={data.email}
                            type="email" className='border border-primary rounded px-1.5' required />
                        <br />
                        ...
                        <div className='flex justify-end space-x-2 mx-4 pt-3'>
                            ...
                            type='button' className='text-gray-400 font-semibold uppercase'>Clear All</button>
                            <button className='bg-primary text-white px-5  font-semibold rounded-2xl'
                                type='button'
